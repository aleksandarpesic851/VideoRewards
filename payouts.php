                            ...
                            <form action="process/add-redeem.php" method="post" enctype="multipart/form-data" class="horizontal-form" />
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" name="payout_points" placeholder="1000" value="" type="text" autocomplete="off" required=""/>
                                        </div>
                                    </div>
                                </div>
	...
	?>
								...
								<li>
									<div class="task align-items-center" style="cursor: auto;">
										<div class="members single">
											<div class="member rounded-circle float-left" style=" border-radius: 0%; width: 60px; height: 60px;">
												<img class="img-fluid" src="<?php echo $payout['payout_thumbnail']; ?>" />
											</div>
										</div>
										<div class="task-desc">
											<p class="task-title text-truncate"><?php echo $payout['payout_title']; ?></p>
											<span class="end-time text-truncate"><?php echo $payout['payout_subtitle']; ?></span>
										</div>
										<div class="members single">
											<div class="float-right">
											<a href="process/redeem.php?id=<?php echo $payout['payout_id']; ?>&action=0" class="btn btn-danger btn-small"><i class="fa fa-eye-slash"></i>Deactivate</a>
											</div>
										</div>
									</div>
								</li>
	...
	?>
								...
								<li>
									<div class="task align-items-center" style="cursor: auto;">
										...
										<div class="members single">
											<div class="float-right">
											<a href="process/redeem.php?id=<?php echo $payout['payout_id']; ?>&action=1" class="btn btn-primary btn-small"><i class="fa fa-eye"></i>Activate</a>
											</div>
										</div>
									</div>
								</li>
