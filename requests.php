					...
					<div class="col-12">
                        <div class="block bg-white table-block mb-4">
                            <div class="block-heading">
                                <h5>All Requests</h5>
                                <p class="mt-2">Showing All Requests from the Users. You can Proccess the Request, Delete the Request (or) Search for the Request.</p>
                            </div>
...
<?php
	...
	?>
		<tr>
            ...
            <td><a href="tracker.php?user=<?php echo $request['username']; ?>" class="btn btn-primary btn-small"><i class="dripicons-graph-line"></i>Track</a>  <a href="process/complete.php?type=complete&id=<?php echo $request['rid']; ?>" class="btn btn-warning btn-small"><i class="dripicons-checkmark"></i>Complete</a></td>
        </tr>
	<?php
    }
?>