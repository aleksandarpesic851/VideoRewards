									...
									<div class="task align-items-center" style="cursor: auto;">
										<div class="members single">
											<div class="member rounded-circle float-left" style=" border-radius: 0%;">
												<img class="img-fluid" src="<?php echo $offerwall['offer_thumbnail']; ?>" />
											</div>
										</div>
										<div class="task-desc">
										...
										<div class="members single">
											...
											<a href="process/featured.php?id=<?php echo $offerwall['offer_id']; ?>&type=<?php echo $offerwall['offer_type']; ?>&action=0" class="btn btn-danger btn-small"><i class="fa fa-eye-slash"></i>Deactivate</a>
											<a href="edit-featured.php?id=<?php echo $offerwall['offer_id']; ?>" class="btn btn-warning btn-small"><i class="fa fa-edit"></i>Edit</i></a>
											</div>
										</div>
									</div>
								</li>
	...
	?>
								...
								<li>
									<div class="task align-items-center" style="cursor: auto;">
										...
										<div class="members single">
											<div class="float-right">
											<a href="process/featured.php?id=<?php echo $offerwall['offer_id']; ?>&type=<?php echo $offerwall['offer_type']; ?>&action=1" class="btn btn-primary btn-small"><i class="fa fa-eye"></i>Activate</a>
											<a href="edit-featured.php?id=<?php echo $offerwall['offer_id']; ?>" class="btn btn-warning btn-small"><i class="fa fa-edit"></i>Edit</i></a>
											</div>
										</div>
									</div>
