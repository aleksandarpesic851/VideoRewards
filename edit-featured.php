<?php
    ...
    if (!admin::isSession()) {
        ...
        $result = $offerwalls->getSingleOffer($ID);
                    ...
                    <div class="col-md-12">
                        <div class="block form-block mb-4">
                            ...
                            <form action="process/edit-featured.php" method="post" enctype="multipart/form-data" class="horizontal-form" />
                                ...
                                <?php if($valid){ if($result['offer_type'] == "startapp"){ ?>
							
                                <div class="form-group">
                                    <div class="form-row">
                                        <label class="col-md-3">StartApp AppId</label>
                                        <div class="col-md-9">
                                            <input class="form-control" name="val1" placeholder="2093300" type="text" value="<?php if($valid){ echo $configs->getConfig('StartApp_AppID'); } ?>" required=""/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        <label class="col-md-3">StartApp Video Credit</label>
                                        <div class="col-md-9">
                                            <input class="form-control" name="points" placeholder="2" type="text" value="<?php if($valid){ echo $configs->getConfig('StartAppVideoCredit_Amount'); } ?>" required=""/>
                                        </div>
                                    </div>
                                </div>
